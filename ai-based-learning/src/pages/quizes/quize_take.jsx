...
const QuizTakePage = () => {
  ...
  if (!quiz || quiz.questions.length === 0) {
    return <p>Quiz not found or has no questions.</p>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
            ...
            {/* Question Card */}
            <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-slate-200/50 p-6 mb-4">
