...
import quizService from "../../services/quize_service";
    ...
    return(
        <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-6">
                ...
                >
                    <ArrowLeft className="w-4 h-4 group-hover:-translate-x-l transition-transform duration-200" strokeWidth={2}/>
                    Back to Document
                </Link>
            </div>
            ...
            {/* Score card */}
            <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 mb-6">
                <div className="text-center space-y-6">
                    <div className="inline-flex item-center justify-center w-15 h-15 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 shadow-lg shadow-emerald-500/25">
                            ...
                            {result.explanation &&(
                                <div className="p-4 bg-linear-to-br from-slate-100/50 border border-slate-200 rounded-xl">
                                    <div className="flex items-start gap-3">
                                        <div className="shrink-0 w-8 h-8 bg-slate-200 flex items-center justify-center mt-0.5">
            ...
            <div className="mt-8 justify-center flex">
                <Link to={`/documents/${quiz.document._id}`}>
                    <button className="group relative px-8 h-12 bg-linear-to-br from-emerald-500 to-teal-500 text-white font-semibold text-sm rounded-xl inline-flex items-center gap-2 hover:from-emerald-600 hover:to-teal-600 transition-all sahdow-lg shadow-emerald-500/25 active:scale-95 duration-200 overflow-hidden">
