...
const FlashcardManager = ({documentId}) => {
    ...
    const renderFlashcardViewer =()=>{
        const currentCard = selectedSet.cards[currentCardIndex];//check this once
        return(
            <div className="space-y-8">
                ...
                >
                    <ArrowLeft className='w-4 h-4 group-hover:-translate-x-l transition-transform duration-299' 
                    strokeWidth={2}/>
                    Back to Sets
                </button>
                ...
                <div className="flex items-center gap-6">
                    ...
                    >
                        <ChevronLeft className='w-4 h-4 group-hover:-translate-x-0.5 transition-transfer duration-200' strokeWidth={2.5}/>
                        Previous
                    </button>
                    ...
                    >
                        Next
                        <ChevronRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transfer duration-200" strokeWidth={2.5}/>
                    </button>
            ...
            return(
                <div className="flex flex-col items-center justify-center py-16 px-6">
                    ...
                    <button
                        ...
                        disabled={generating}
                        className='group inline-flex items-center gap-2 px-6 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shower-emerald-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active-scale-100'
                    >
                        {generating?(
                            <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {flashcardSets.map((set)=>(
                        <div
                            ...
                            className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-slate-500/10'
                        >
                            {/* Delete Button */}
                            <button
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className='text-xs font-medium text-slate-500 uppercase tracking-wide'>
                                        Created{moment(set.createdAt).format("MMM, D, YY")}
                                    </p>
                                </div>
  ...
  return (
    <>
    <div className="bg-white/80 backdrop-blur-xl border border-slate-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-8">
    ...
    >
        <div className="space-y-6">
            <p className="text-sm text-slate-600">
                Are you sure you want to delete this flashcard set? This action cannot be undone and all cards and all cards will be permanently removed.
            </p>
