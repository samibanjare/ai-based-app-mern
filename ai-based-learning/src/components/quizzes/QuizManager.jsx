...
import quizService from '../../services/quize_service.js'
import aiService from '../../services/ai_service.js'
import Spinner from '../common/spinner.jsx'
import Button from '../common/button.jsx'
import Modal from '../common/modal.jsx'
import QuizCard from './QuizCard.jsx'
import EmptySpace from '../common/EmptySpace.jsx'
            ...
            title="Confirm Delete Quiz">
                <div className="space-y-4">
                    <p className="text-sm text-neutral-600">
                        Are you sure you want to delete the quiz: <span className="font-semibold text-neutral-900">{selectedQuiz?.title || 'this quiz'}</span>?This action can not be undone.
                    </p>
                    <div className="flex justify-end gap-2 pt-2">
                        <Button
                            type='button'
